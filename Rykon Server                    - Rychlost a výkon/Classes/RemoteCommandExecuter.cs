...
{
    public enum RemoteCommandType { ReadFile, WriteFile, MessageBox, CreateFile, CreateDir, Sleep, CloseProcess, CloseAllProcess, unkown, process, MoveMouse, MouseClick, MuteSystemSound, MouseRightClick, PrintScreenShot, LS }
